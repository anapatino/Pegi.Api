...
public record ProposalResponse(string? Code, string? PersonDocument1,string? PersonDocument2,string? EvaluatorDocument,string? TutorDocument,
    ...
    string? Bibliographical, string? Status,string? ResearchLine, string? ResearchSubline, string? AreaThematic, string? InvestigationGroupName, string? areaThematicCode);
